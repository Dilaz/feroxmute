...
pub fn generate_markdown(report: &Report) -> String {
    ...
    md.push_str("This report was generated by feroxmute, an LLM-powered penetration testing tool. ");
    md.push_str("Findings should be validated by qualified security professionals before taking action.\n");
